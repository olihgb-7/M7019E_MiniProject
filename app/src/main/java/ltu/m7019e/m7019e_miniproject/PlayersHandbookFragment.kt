...
class PlayersHandbookFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if(resources.configuration.orientation == Configuration.ORIENTATION_LANDSCAPE){
            ...
            binding.playersHandbookLink.visibility = View.GONE
            ...
            binding.playersHandbookProgressBar.visibility = View.GONE
            binding.playersHandbookLink.visibility = View.VISIBLE
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.playersHandbookLink.setOnClickListener {
            val intent = Intent(Intent.ACTION_VIEW)
            intent.data = Uri.parse(Constants.DND_WOTC_URL)
